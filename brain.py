...
def run_orchestrator(ind, maturity, frictions):
    try:
        ...
        prompt = f"""
        Role: IQ Business Lead Strategist. Methodology: GESHIDO®.
        Industry: {ind} | Maturity: {maturity} | Friction: {frictions}.
        
        Mandatory Dashboard Format (No stars **):
        [VISION] 1-sentence high-impact vision.
        [KPI] Specific 'Before' vs 'After' impact.
