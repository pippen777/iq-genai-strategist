...
def apply_iq_styles():
    ...
    /* 3. THE SELECTED STATE: NEON GRADIENT */
    .selected-btn div.stButton > button {
        background: linear-gradient(90deg, #00ADEF, #8E2DE2) !important; /* IQ Blue to Purple */
        color: #ffffff !important;
