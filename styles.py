...
def apply_iq_styles():
    ...
    /* Target specifically to override Streamlit defaults */
    div.stButton > button {
    ...
    /* This class is applied via the wrapper in app.py */
