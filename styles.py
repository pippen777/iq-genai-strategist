...
def apply_iq_styles():
    ...
    /* THE "FORCED" SELECTION LOCK */
    /* This targets the specific button component inside our selected-btn wrapper */
    div.selected-btn [data-testid="stBaseButton-secondary"] {
        background: linear-gradient(to right, #00ADEF, #8E2DE2, #F02FC2) !important;
        border: none !important;
        transform: translateY(-5px) scale(1.02) !important;
        box-shadow: 0 0 40px rgba(0, 173, 239, 0.8) !important;
        color: white !important;
    }
